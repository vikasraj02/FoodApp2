...
MIDDLEWARE = [
    ...
    'orders.request_object.RequestObjectMiddleware', #custom middleware created for request object in models.py
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'account.context_processors.get_customer_profile',
