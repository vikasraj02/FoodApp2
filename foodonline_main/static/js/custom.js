...
$(document).ready(function(){
    $(".add_to_cart").on("click", function(e){
        ...
        //place the item quantity to load
    ...
    function checkEmptyCart(){
        var cartQut = document.getElementById("cart_counter").innerHTML
        if(cartQut == 0){
    ...
    $(".add_hour").on("click", function(e) {
        ...
        var csrf_token = $('input[name=csrfmiddlewaretoken]').val();  // Fix: Added a closing square bracket
        ...
        if (eval(condition)) {
            $.ajax({
                ...
                success : function(response) {
                    if(response.status == 'Success'){
                        ...
                        document.getElementById('openings_hours').reset();
                    }else{
                        swal(response.message, '', 'error')
                    }
                }
            ...
            swal("please fill the form",'', 'info');
        }
    });
    //Remove Opening Hour
